...
- (void)screenRotation
{
    ...
    _dateBackView.center = CGPointMake(SCREEN_WIDTH/2, SCREEN_HEIGHT/2);
}
...
- (void)createDatePicker
{
    ...
    if (SCREEN_WIDTH < 768)
    {
        dateBackView.frame = CGRectMake(0, 0, SCREEN_WIDTH-20, 306);
    }else
    {
        dateBackView.frame = CGRectMake(0, 0, 400, 306);
    }
    dateBackView.center = CGPointMake(SCREEN_WIDTH/2, SCREEN_HEIGHT/2);
