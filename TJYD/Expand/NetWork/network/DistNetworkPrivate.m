...
@implementation DistNetworkPrivate
...
@implementation DistBaseRequest (RequestAccessory)

- (void)toggleAccessoriesWillStartCallBack {
    
    for (id<DistRequestAccessory> accessory in self.requestAccessories) {
...
@implementation DistBatchRequest (RequestAccessory)
...
@implementation DistChainRequest (RequestAccessory)
