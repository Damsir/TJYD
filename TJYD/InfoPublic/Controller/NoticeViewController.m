...
- (void)loadData {
    ...
    NSString *des = [DES encryptUseDES:[[NSString stringWithFormat:@"action==noticeInfo/getAllNoticeList.do?noticeStyle=GSGG&pageIndex=%ld&pageSize=%ld&queryFilter=,%@",_pageIndex,(long)_pageSize,ticket] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding] key:Key];
