...
- (void)loadData {
    ...
    NSString *des = [DES encryptUseDES:[[NSString stringWithFormat:@"action==noticeInfo/getAllNoticeList.do?noticeStyle=YNXW&pageIndex=%ld&pageSize=%ld&queryFilter=,%@",_pageIndex,_pageSize,ticket] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding] key:Key];
