...
//		self.labelFont = [UIFont boldSystemFontOfSize:kLabelFontSize];
        self.labelFont = [UIFont fontWithName:Font_PingFangSC_Medium size:kLabelFontSize];
		self.labelColor = [UIColor whiteColor];
//		self.detailsLabelFont = [UIFont boldSystemFontOfSize:kDetailsLabelFontSize];
        self.detailsLabelFont = [UIFont fontWithName:Font_PingFangSC_Medium size:kDetailsLabelFontSize];
